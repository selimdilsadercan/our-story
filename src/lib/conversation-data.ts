...
export const conversationTimeline: ConversationItem[] = [
    ...
    { type: 'dialogue', speaker: 'isil', line: "Knk Nurmelek bana 'arkadaş olarak görüyor' dememi söyledi. Ben sadece elçiyim." },
    ...
    { type: 'dialogue', speaker: 'selim', line: "Hoşlandığın tip nedir?" },
