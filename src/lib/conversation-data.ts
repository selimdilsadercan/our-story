...
export const conversations: ConversationScene[] = [
    ...
    {
        situation: "İkisinin de yurda döndüğü bir gün WhatsApp'tan birbirlerine en sevdikleri şarkıları atarlar, tüm gece birbirleriyle konuşurlar.",
        dialogue: []
    },
    {
    ...
    {
        situation: "Nurmelek'in kafası iyice karışmıştır. Arkadaşı Işıl'a eğer Selim bir şey sorarsa 'arkadaş olarak gördüğünü' söylemesini söyler.",
        dialogue: []
    },
    {
    ...
    {
        situation: "Selim, Nurmelek'e genel, ilişkiler hakkında ve kişiyi tanımaya yönelik bir sürü soru sorar. Nurmelek, Selim'in çok kız arkadaşı olmasından rahatsızdır ve bunu dile getirmiştir.",
        dialogue: [
    ...
    {
        situation: "Bu sorular sonrası gölete inerler ve gün doğumunu izlemeye başlarlar. Ufak temaslar ederek uzun süre otururlar. Selim durumdan rahatsız olmuştur.",
        dialogue: [
    ...
    {
        situation: "Ramazan boyunca birlikte zaman geçirirler her gece birlikte sahur yaparlar. Sahuru beklerken Selim'in kitap okuduğu, Nurmelek'in de gözlerini dinlendirdiği bir gün, Nurmelek yanlışlıkla gaz çıkartır. Başarım: İlk gaz çıkarma!",
        dialogue: []
    },
    {
